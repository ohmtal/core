/*
need $Client::configFile configured! 
...
function OptionsDlg::onWake(%this)
{
   ...
   if ($pref::lightManager $= "Basic Lighting")
   {
      //prevent crash! from switching
      %this-->OptLightingQualityPopup.setVisible(false);
   } else {
      //aa is disabled in adv lighting so hide it:
      %aaMenu.setVisible(false);
   }
...
$RemapCount++;
$RemapName[$RemapCount] = "Left";
$RemapCmd[$RemapCount] = "moveleft";
$RemapCount++;
$RemapName[$RemapCount] = "Right";
$RemapCmd[$RemapCount] = "moveright";
$RemapCount++;
$RemapName[$RemapCount] = "Up";
$RemapCmd[$RemapCount] = "moveup";
$RemapCount++;
$RemapName[$RemapCount] = "Down";
...
dWarn("REMAPPING moveMap.getCommand(",%device,",",%action,") == ",%prevMap);  
